...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private void launchHomeScreen() {
        ...
        if(Util.hasInternet(this)){
            SharedPreferencesUtil.setBoolean(WelcomeActivity.this, Const.APP.IS_FIRST_TIME_LAUNCH,false);
            startActivity(new Intent(WelcomeActivity.this, ChooseConsorcioActivity.class));
            finish();
        }else{
            MessageUtil.showNeedInternet(this);
        }
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            TextView title = view.findViewById(R.id.screen_textView_title);
            title.setTypeface(FontUtil.getRegularFont(getApplication()));
            TextView subTitle = view.findViewById(R.id.screen_textView_sub_title);
            subTitle.setTypeface(FontUtil.getLightFont(getApplication()));
